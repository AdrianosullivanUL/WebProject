        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" name="challenge"  class="form-group" role="form" onSubmit="return submitForm()" AUTOCOMPLETE = "off" >        
            ...
            <div class="topnav">
                ...
                <div class="topnav-right">
                    ...
                    <button class="btn btn-primary" name="btnAction" type="submit" value="EditProfile"><img height="24" width="24"  title="Edit Profile" src='/images/Edit.png'/></button>
                    <button name="btnAction" class="btn btn-secondary" type="submit" value="MatchFinder"><img height="24" width="24"  title="Match Finder" src='/images/Find.png'/></button></button>                        
                    <button name="btnAction" class="btn btn-warning" type="submit" value="Logoff"><img height="24" width="24"  title="Logoff" src='/images/Logoff.png'/></button></button>
                    <button name="btnAction" class="btn btn-danger" type="submit" value="RemoveAccount"><img height="24" width="24"  title="Remove Account" src='/images/Delete.png'/></button></button>
